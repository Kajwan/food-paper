...
This is an updated version of pythom_import code in https://github.com/fineprint-global/fabio/tree/data-2010-current.
Original version was written by jonas.bunsen@tu-berlin.de.
while this updated veersion was written by kajwan.rasul@ntnu.no
